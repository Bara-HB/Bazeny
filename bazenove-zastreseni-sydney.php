...
<body>
  ...
  <section class="max-w-6xl mx-auto px-4">
    ...
    <h2 class="text-center text-2xl md:text-3xl font-bold my-8">Bazénové zastřešení Sydney</h2>
...
<!-- První karta -->
        <div class="bg-white rounded-lg shadow-custom p-6 my-8">
          ...
          <div class="grid md:grid-cols-2 gap-4">
            <div>
              <h3 class="text-base sm:text-lg font-semibold mb-4">Sydney 3,5 x 5,55 m</h3>
              <img 
                src="assets/image/bazenove-zastreseni-sydney.png" 
                alt="Sydney 3,5 x 5,55 m" 
              ...
              <table class="table-auto w-full mb-4 border-b text-sm sm:text-base">
                ...
                <tbody>
                  ...
                  <tr class="hover:bg-sky-200">
                    ...
                    <td class="px-4 py-2 border-b">299 kg</td>
                  </tr>
                  <tr class="hover:bg-sky-200">
                    <td class="px-4 py-2 border-b">Varianta kolejí</td>
                    <td class="px-4 py-2 border-b">Jednokolejové</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <table class="table-auto w-full text-sm sm:text-base">
              <tbody>
                ...
                <tr class="hover:bg-sky-200">
                  ...
                  <td class="px-4 py-2 border-b">358</td>
                </tr>
                <tr class="hover:bg-sky-200">
                ...
                <tr class="hover:bg-sky-200">
                  ...
                  <td class="px-4 py-2 border-b">386</td>
                </tr>
                <tr class="hover:bg-sky-200">
                  <td class="px-4 py-2 border-b">Vnější délka zastřešení "E" [cm]</td>
                  <td class="px-4 py-2 border-b">565</td>
                </tr>
                <tr class="hover:bg-sky-200">
                ...
                <tr class="hover:bg-sky-200">
                  ...
                  <td class="px-4 py-2 border-b">350 x 555</td>
                </tr>
                <tr class="hover:bg-sky-200">
                ...
                <tr class="hover:bg-sky-200">
                  ...
                  <td class="px-4 py-2 border-b">Ne</td>
                </tr>
              </tbody>
            </table>
          </div>
...
<!-- Druhá karta -->
        <div class="bg-white rounded-lg shadow-custom p-6 my-8">
          ...
          <div class="grid md:grid-cols-2 gap-4"> 
            <div>
              <h3 class="text-base sm:text-lg font-semibold mb-4">Sydney 3,5 x 6,35 m</h3>
              <img 
                src="assets/image/bazenove-zastreseni-sydney.png" 
                alt="Sydney 3,5 x 6,35 m" 
                class="w-full h-auto rounded-lg mb-4"
              >
            </div>
            ...
            <div>
              <table class="table-auto w-full mb-4 border-b text-sm sm:text-base">
                ...
                <tbody>
                  ...
                  <tr class="hover:bg-sky-200">
                    <td class="px-4 py-2 border-b">Váha produktu</td>
                    <td class="px-4 py-2 border-b">309 kg</td>
                  </tr>
                  <tr class="hover:bg-sky-200">
                    <td class="px-4 py-2 border-b">Varianta kolejí</td>
                    <td class="px-4 py-2 border-b">Jednokolejové</td>
          ...
          <div id="additionalDetails_card2" class="hidden mt-6">
            <table class="table-auto w-full text-sm sm:text-base">
              <tbody>
                ...
                <tr class="hover:bg-sky-200">
                  <td class="px-4 py-2 border-b">Maximální zastřešená plocha cm [ŠxD]</td>
                  <td class="px-4 py-2 border-b">350 x 635</td>
                </tr>
                <tr class="hover:bg-sky-200">
                  <td class="px-4 py-2 border-b">Přední čelo zastřešení</td>
                  <td class="px-4 py-2 border-b">Napevno</td>
...
<!-- Třetí karta -->
        <div class="bg-white rounded-lg shadow-custom p-6 my-4">
          ...
          <div class="grid md:grid-cols-2 gap-4"> 
            <div>
              <h3 class="text-base sm:text-lg font-semibold mb-4">Sydney 4 x 7,4 m</h3>
              <img 
                src="assets/image/bazenove-zastreseni-sydney.png" 
                alt="Sydney 4 x 7,4 m" 
                class="w-full h-auto rounded-lg mb-4"
              >
            </div>
            ...
            <div>
              <table class="table-auto w-full mb-4 border-b text-sm sm:text-base">
                ...
                <tbody>
                  ...
                  <tr class="hover:bg-sky-200">
                    <td class="px-4 py-2 border-b">Váha produktu</td>
                    <td class="px-4 py-2 border-b">433 kg</td>
                  </tr>
                  <tr class="hover:bg-sky-200">
                    <td class="px-4 py-2 border-b">Varianta kolejí</td>
                    <td class="px-4 py-2 border-b">Jednokolejové</td>
          ...
          <div id="additionalDetails_card3" class="hidden mt-6">
            <table class="table-auto w-full text-sm sm:text-base">
              <tbody>
                ...
                <tr class="hover:bg-sky-200">
                  <td class="px-4 py-2 border-b">Vnitřní šířka zastřešení "A" [cm]</td>
                  <td class="px-4 py-2 border-b">408</td>
                </tr>
                <tr class="hover:bg-sky-200">
                  <td class="px-4 py-2 border-b">Vnější výška zastřešení "V" [cm]</td>
                  <td class="px-4 py-2 border-b">56</td>
                </tr>
                <tr class="hover:bg-sky-200">
                  <td class="px-4 py-2 border-b">Vnější šířka zastřešení "B" [cm]</td>
                  <td class="px-4 py-2 border-b">450</td>
                </tr>
                <tr class="hover:bg-sky-200">
                  <td class="px-4 py-2 border-b">Vnější délka zastřešení "E" [cm]</td>
                  <td class="px-4 py-2 border-b">752</td>
                </tr>
                <tr class="hover:bg-sky-200">
                  <td class="px-4 py-2 border-b">Krytina předního čela</td>
                  <td class="px-4 py-2 border-b">Čírý polykarbonát 4 mm</td>
                ...
                <tr class="hover:bg-sky-200">
                  <td class="px-4 py-2 border-b">Maximální zastřešená plocha cm [ŠxD]</td>
                  <td class="px-4 py-2 border-b">400 x 740</td>
                </tr>
                <tr class="hover:bg-sky-200">
                  <td class="px-4 py-2 border-b">Přední čelo zastřešení</td>
                  <td class="px-4 py-2 border-b">Napevno</td>
...
<div class="bg-white rounded-lg shadow-custom p-6 my-4">
          ...
          <div class="grid md:grid-cols-2 gap-4"> 
            <div>
              <h3 class="text-base sm:text-lg font-semibold mb-4">Sydney 4 x 8,5 m</h3>
              <img 
                src="assets/image/bazenove-zastreseni-sydney.png" 
                alt="Sydney 4 x 8,5 m" 
                class="w-full h-auto rounded-lg mb-4"
              >
            </div>
            ...
            <div>
              <table class="table-auto w-full mb-4 border-b text-sm sm:text-base">
                ...
                <tbody>
                  ...
                  <tr class="hover:bg-sky-200">
                    <td class="px-4 py-2 border-b">Váha produktu</td>
                    <td class="px-4 py-2 border-b">443 kg</td>
                  </tr>
                  <tr class="hover:bg-sky-200">
                    <td class="px-4 py-2 border-b">Varianta kolejí</td>
                    <td class="px-4 py-2 border-b">Jednokolejové</td>
          ...
          <div id="additionalDetails_card4" class="hidden mt-6">
            <table class="table-auto w-full text-sm sm:text-base">
              <tbody>
                ...
                <tr class="hover:bg-sky-200">
                  <td class="px-4 py-2 border-b">Maximální zastřešená plocha cm [ŠxD]</td>
                  <td class="px-4 py-2 border-b">400 x 850</td>
                </tr>
                <tr class="hover:bg-sky-200">
                  <td class="px-4 py-2 border-b">Přední čelo zastřešení</td>
                  <td class="px-4 py-2 border-b">Napevno</td>
...
<!-- Pátá karta -->
        <div class="bg-white rounded-lg shadow-custom p-6 my-4">
          ...
          <div class="grid md:grid-cols-2 gap-4"> 
            <div>
              <h3 class="text-base sm:text-lg font-semibold mb-4">Sydney 4,5 x 8,5 m</h3>
              <img 
                src="assets/image/bazenove-zastreseni-sydney.png" 
                alt="Sydney 4,5 x 8,5 m" 
                class="w-full h-auto rounded-lg mb-4"
              >
            </div>
            ...
            <div>
              <table class="table-auto w-full mb-4 border-b text-sm sm:text-base">
                ...
                <tbody>
                  ...
                  <tr class="hover:bg-sky-200">
                    <td class="px-4 py-2 border-b">Váha produktu</td>
                    <td class="px-4 py-2 border-b">471 kg</td>
                  </tr>
                  <tr class="hover:bg-sky-200">
                    <td class="px-4 py-2 border-b">Varianta kolejí</td>
                    <td class="px-4 py-2 border-b">Jednokolejové</td>
          ...
          <div id="additionalDetails_card5" class="hidden mt-6">
            <table class="table-auto w-full text-sm sm:text-base">
              <tbody>
                ...
                <tr class="hover:bg-sky-200">
                  <td class="px-4 py-2 border-b">Vnější výška zastřešení "V" [cm]</td>
                  <td class="px-4 py-2 border-b">58</td>
                </tr>
                <tr class="hover:bg-sky-200">
                  <td class="px-4 py-2 border-b">Vnější šířka zastřešení "B" [cm]</td>
                ...
                <tr class="hover:bg-sky-200">
                  <td class="px-4 py-2 border-b">Maximální zastřešená plocha cm [ŠxD]</td>
                  <td class="px-4 py-2 border-b">450 x 850</td>
                </tr>
                <tr class="hover:bg-sky-200">
                  <td class="px-4 py-2 border-b">Přední čelo zastřešení</td>
                  <td class="px-4 py-2 border-b">Napevno</td>
...
<div class="bg-white rounded-lg shadow-custom p-6 my-4">
          ...
          <div class="grid md:grid-cols-2 gap-4"> 
            <div>
              <h3 class="text-base sm:text-lg font-semibold mb-4">Sydney CLEAR 3,5 x 6,35 m</h3>
              <img 
                src="assets/image/bazenove-zastreseni-sydney.png" 
                alt="Sydney CLEAR 3,5 x 6,35 m" 
                class="w-full h-auto rounded-lg mb-4"
              >
            </div>
            ...
            <div>
              <table class="table-auto w-full mb-4 border-b text-sm sm:text-base">
                ...
                <tbody>
                  ...
                  <tr class="hover:bg-sky-200">
                    <td class="px-4 py-2 border-b">Váha produktu</td>
                    <td class="px-4 py-2 border-b">504 kg</td>
                  </tr>
                  <tr class="hover:bg-sky-200">
                    <td class="px-4 py-2 border-b">Varianta kolejí</td>
                    <td class="px-4 py-2 border-b">Jednokolejové</td>
...
<div class="bg-white rounded-lg shadow-custom p-6 my-4">
          ...
          <div class="grid md:grid-cols-2 gap-4"> 
            <div>
              <h3 class="text-base sm:text-lg font-semibold mb-4">Sydney CLEAR 4 x 7,4 m</h3>
              <img 
                src="assets/image/bazenove-zastreseni-sydney.png" 
                alt="Sydney CLEAR 4 x 7,4 m" 
                class="w-full h-auto rounded-lg mb-4"
              >
            </div>
            ...
            <div>
              <table class="table-auto w-full mb-4 border-b text-sm sm:text-base">
                ...
                <tbody>
                  ...
                  <tr class="hover:bg-sky-200">
                    <td class="px-4 py-2 border-b">Váha produktu</td>
                    <td class="px-4 py-2 border-b">562 kg</td>
                  </tr>
                  <tr class="hover:bg-sky-200">
                    <td class="px-4 py-2 border-b">Varianta kolejí</td>
                    <td class="px-4 py-2 border-b">Jednokolejové</td>
...
<!-- Osmá karta -->
        <div class="bg-white rounded-lg shadow-custom p-6 my-4">
          ...
          <div class="grid md:grid-cols-2 gap-4"> 
            <div>
              <h3 class="text-base sm:text-lg font-semibold mb-4">Sydney CLEAR 4 x 8,5 m</h3>
              <img 
                src="assets/image/bazenove-zastreseni-sydney.png" 
                alt="Sydney CLEAR 4 x 8,5 m" 
                class="w-full h-auto rounded-lg mb-4"
              >
            </div>
            ...
            <div>
              <table class="table-auto w-full mb-4 border-b text-sm sm:text-base">
                ...
                <tbody>
                  ...
                  <tr class="hover:bg-sky-200">
                    <td class="px-4 py-2 border-b">Váha produktu</td>
                    <td class="px-4 py-2 border-b">572 kg</td>
                  </tr>
                  <tr class="hover:bg-sky-200">
                    <td class="px-4 py-2 border-b">Varianta kolejí</td>
                    <td class="px-4 py-2 border-b">Jednokolejové</td>
...
<div class="bg-white rounded-lg shadow-custom p-6 my-4">
          ...
          <div class="grid md:grid-cols-2 gap-4"> 
            <div>
              <h3 class="text-base sm:text-lg font-semibold mb-4">Sydney CLEAR 4,5 x 8,5 m</h3>
              <img 
                src="assets/image/bazenove-zastreseni-sydney.png" 
                alt="Sydney CLEAR 4,5 x 8,5 m" 
                class="w-full h-auto rounded-lg mb-4"
              >
            </div>
            ...
            <div>
              <table class="table-auto w-full mb-4 border-b text-sm sm:text-base">
                ...
                <tbody>
                  ...
                  <tr class="hover:bg-sky-200">
                    <td class="px-4 py-2 border-b">Váha produktu</td>
                    <td class="px-4 py-2 border-b">632 kg</td>
                  </tr>
                  <tr class="hover:bg-sky-200">
                    <td class="px-4 py-2 border-b">Varianta kolejí</td>
                    <td class="px-4 py-2 border-b">Jednokolejové</td>
...
<!-- Další parametry, skryté ve výchozím stavu -->
          <div id="additionalDetails_card9" class="hidden mt-6">
            <table class="table-auto w-full text-sm sm:text-base">
              <tbody>
                <tr class="hover:bg-sky-200">
                  <td class="px-4 py-2 border-b">Barva konstrukce</td>
  ...
  function toggleDetails(cardId) {
    ...
    const button = document.getElementById(`toggleButton_${cardId}`);
